...
}("undefined" != typeof window ? window : this, function (a, b)
{
	...
	}, n.extend = n.fn.extend = function ()
	{
		...
		for ("boolean" == typeof g && (j = g, g = arguments[h] ||
			{}, h++), "object" == typeof g || n.isFunction(g) || (g = {}), h === i && (g = this, h--); h < i; h++)
			if (null != (e = arguments[h]))
				for (d in e) a = g[d], c = e[d], "__proto__" !== d && g !== c && (j && c && (n.isPlainObject(c) || (b = n.isArray(c))) ? (b ? (b = !1, f = a && n.isArray(a) ? a : []) : f = a && n.isPlainObject(a) ? a :
	...
	n.event = {
		...
		add: function (a, b, c, d, e)
		{
			...
			if (r)
			{
				...
				while (h--) f = na.exec(b[h]) || [], o = q = f[1], p = (f[2] || "").split(".").sort(), o && (j = n.event.special[o] ||
		...
		trigger: function (b, c, e, f)
		{
				...
				{}, f || !l.trigger || !1 !== l.trigger.apply(e, c)))
			{
				...
				{})[b.type] && n._data(i, "handle"), g && g.apply(i, c), (g = h && i[h]) && g.apply && L(i) && (b.result = g.apply(i, c), !1 === b.result && b.preventDefault());
		...
		dispatch: function (a)
		{
			...
			if (i[0] = a, a.delegateTarget = this, !k.preDispatch || !1 !== k.preDispatch.call(this, a))
			{
				...
				while ((f = h[b++]) && !a.isPropagationStopped())
				{
					...
					while ((g = f.handlers[c++]) && !a.isImmediatePropagationStopped()) a.rnamespace && !a.rnamespace.test(g.namespace) || (a.handleObj = g, a.data = g.data, void 0 !== (d = ((n.event.special[g.origType] ||
					{}).handle || g.handler).apply(f.elem, i)) && !1 === (a.result = d) && (a.preventDefault(), a.stopPropagation()))
				}
