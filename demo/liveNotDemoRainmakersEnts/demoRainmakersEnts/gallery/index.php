...
<body>
    ...
    <div id="page-banner-area" class="page-banner-area" style="background-image:url(../img/banner.jpg);">
        <div class="page-banner-title ">
            <div class="text-center">
                <p class="banner-title">Gallery</p>
        ...
        <section class="elementor-element elementor-element-f3dd23a elementor-section-boxed elementor-section">
            <div class="elementor-container elementor-column-gap-default">
                <div class="elementor-row">
                    <div class="elementor-column">
                        <div class="elementor-element-populated">
                            <div class="elementor-widget-wrap">
                                <div class="elementor-element elementor-element-23036b8">
                                    <div class="elementor-widget-container">
                                        <div class="title-section-area">
                                            <h2 class="section-title"> <span class="sub-title">Previous Event</span> PICTURES</h2> <span class="title-shape"> <svg xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' width='71px' height='11px'> <path fill-rule='evenodd' d='M59.669,10.710 L49.164,3.306 L39.428,10.681 L29.714,3.322 L20.006,10.682 L10.295,3.322 L1.185,10.228 L-0.010,8.578 L10.295,0.765 L20.006,8.125 L29.714,0.765 L39.428,8.125 L49.122,0.781 L59.680,8.223 L69.858,1.192 L70.982,2.895 L59.669,10.710 Z'/></svg> </span></div>
                                    </div>
                                </div>
                                <div class="elementor-element elementor-element-b06034a">
                                    <div class="elementor-widget-container">
    ...
    <!--lightbox gallery scripts-->
    <script type='text/javascript' src='../js/frontend-modules.min-2.7.5.js'></script>
    <script type='text/javascript' src='../js/lib/dialog/dialog.min-4.7.3.js'></script>
    <script type='text/javascript' src='../js/lib/swiper/swiper.min-4.4.6.js'></script>
